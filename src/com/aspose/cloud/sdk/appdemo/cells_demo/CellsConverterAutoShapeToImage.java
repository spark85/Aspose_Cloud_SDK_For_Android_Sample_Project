...
public class CellsConverterAutoShapeToImage extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_converter_autoshapetoimage);
		init();
		...
		function_arg3
				.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
					...
					public void onNothingSelected(AdapterView<?> arg0) {
						// TODO Auto-generated method stub
						Toast.makeText(CellsConverterAutoShapeToImage.this,
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsConverterAutoShapeToImage.this);
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_converter_autoshapetoimage_arg1);
		function_arg2 = (EditText) findViewById(R.id.cells_converter_autoshapetoimage_arg2);
		function_arg3 = (Spinner) findViewById(R.id.cells_converter_autoshapetoimage_arg3);
