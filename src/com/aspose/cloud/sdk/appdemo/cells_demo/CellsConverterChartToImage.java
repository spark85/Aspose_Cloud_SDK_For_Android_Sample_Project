...
public class CellsConverterChartToImage extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cells_converter_charttoimage);
		init();
		...
		function_arg3
				.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
					...
					public void onNothingSelected(AdapterView<?> arg0) {
						// TODO Auto-generated method stub
						Toast.makeText(CellsConverterChartToImage.this,
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							CellsConverterChartToImage.this);
					dialog.setTitle("Error");
					dialog.setMessage("Please Enter Require Fields");
					dialog.setNeutralButton("Ok", null);
					dialog.show();
				} else {
					index = Integer.parseInt(function_arg1.getText().toString());
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.cells_converter_charttoimage_arg1);
		function_arg2 = (EditText) findViewById(R.id.cells_converter_charttoimage_arg2);
		function_arg3 = (Spinner) findViewById(R.id.cells_converter_charttoimage_arg3);
