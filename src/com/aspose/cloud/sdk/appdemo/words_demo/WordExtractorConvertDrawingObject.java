...
public class WordExtractorConvertDrawingObject extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.words_extractor_convertdrawingobject);
		init();
		function_arg3
				.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
					...
					public void onNothingSelected(AdapterView<?> arg0) {
						// TODO Auto-generated method stub
						Toast.makeText(WordExtractorConvertDrawingObject.this,
								"Please Select A Format", Toast.LENGTH_LONG)
								.show();
					}
				});
			...
			public void onClick(View v) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							WordExtractorConvertDrawingObject.this);
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.word_extractor_convertdrawingobject_arg1);
		function_arg2 = (EditText) findViewById(R.id.word_extractor_convertdrawingobject_arg2);
		function_arg4 = (EditText) findViewById(R.id.word_extractor_convertdrawingobject_arg4);
		function_arg3 = (Spinner) findViewById(R.id.word_extractor_convertdrawingobject_arg3);
