...
public class WordExtractorGetOleData extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.words_extractor_getoledata);
		init();
		function_arg3
				.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
					...
					public void onNothingSelected(AdapterView<?> arg0) {
						// TODO Auto-generated method stub
						Toast.makeText(WordExtractorGetOleData.this,
								"Please Select A Render Format",
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.word_extractor_getoledata_arg1);
		function_arg2 = (EditText) findViewById(R.id.word_extractor_getoledata_arg2);
		function_arg4 = (EditText) findViewById(R.id.word_extractor_getoledata_arg4);
		function_arg3 = (Spinner) findViewById(R.id.word_extractor_getoledata_arg3);
