...
public class PdfConverterGetImage1 extends Activity {
	private EditText constructor_arg1;
	private EditText function_arg1, function_arg2, function_arg5,
			function_arg6;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_converter_getimage1);
		init();
		function_arg3
				.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
					...
					public void onNothingSelected(AdapterView<?> arg0) {
						// TODO Auto-generated method stub
						Toast.makeText(PdfConverterGetImage1.this,
			...
			public void onClick(View v) {
				...
				if (function_arg1.getText().length() == 0
					...
					pageNumber = Integer.parseInt(function_arg2.getText()
							.toString());
					imageHeight = Integer.parseInt(function_arg5.getText()
							.toString());
					imageWidth = Integer.parseInt(function_arg6.getText()
							.toString());
					...
					if (response) {
						result.append("Image converted and downloaded in 'SaasposeConvertedFiles' Folder in SDCard");
					} else {
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.pdf_converter_getimage1_arg1);
		function_arg2 = (EditText) findViewById(R.id.pdf_converter_getimage1_arg2);
		function_arg5 = (EditText) findViewById(R.id.pdf_converter_getimage1_arg5);
		function_arg6 = (EditText) findViewById(R.id.pdf_converter_getimage1_arg6);
		function_arg3 = (Spinner) findViewById(R.id.pdf_converter_getimage1_arg3);
		function_arg3.setAdapter(new ArrayAdapter<ConvertImageFormat>(this,
				android.R.layout.simple_list_item_1, ConvertImageFormat
						.values()));
		function_arg4 = (Spinner) findViewById(R.id.pdf_converter_getimage1_arg4);
