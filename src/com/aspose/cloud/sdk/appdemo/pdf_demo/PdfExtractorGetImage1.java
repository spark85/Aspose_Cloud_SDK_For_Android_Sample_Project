...
public class PdfExtractorGetImage1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_extractor_getimage1);
		init();
		function_arg4
				.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
					...
					public void onNothingSelected(AdapterView<?> arg0) {
						// TODO Auto-generated method stub
						Toast.makeText(PdfExtractorGetImage1.this,
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					imageIndex = Integer.parseInt(function_arg3.getText()
							.toString());
					imageHeight = Integer.parseInt(function_arg6.getText()
							.toString());
					imageWidth = Integer.parseInt(function_arg7.getText()
							.toString());
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.pdf_extractor_getimage1_arg1);
		function_arg2 = (EditText) findViewById(R.id.pdf_extractor_getimage1_arg2);
		function_arg3 = (EditText) findViewById(R.id.pdf_extractor_getimage1_arg3);
		function_arg6 = (EditText) findViewById(R.id.pdf_extractor_getimage1_arg6);
		function_arg7 = (EditText) findViewById(R.id.pdf_extractor_getimage1_arg7);
		function_arg4 = (Spinner) findViewById(R.id.pdf_extractor_getimage1_arg4);
		function_arg4.setAdapter(new ArrayAdapter<ExtractImageFormat>(this,
				android.R.layout.simple_list_item_1, ExtractImageFormat
						.values()));
		function_arg5 = (Spinner) findViewById(R.id.pdf_extractor_getimage1_arg5);
