...
public class PdfAnnotationEditorDownloadAttachment extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pdf_annotationeditor_downloadattachment);
		init();
			...
			public void onClick(View arg0) {
				...
				if (function_arg1.getText().length() == 0
					...
					AlertDialog.Builder dialog = new AlertDialog.Builder(
							PdfAnnotationEditorDownloadAttachment.this);
					...
					attachmentIndex = Integer.parseInt(function_arg2.getText()
							.toString());
	...
	private void init() {
		...
		function_arg1 = (EditText) findViewById(R.id.pdf_annotationeditor_downloadattachment_arg1);
		function_arg2 = (EditText) findViewById(R.id.pdf_annotationeditor_downloadattachment_arg2);
